...
<head>
    ...
    <title>房贷计算器最新2018_房贷计算器2018_房贷计算器</title>
    ...
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://www.fangdaijisuanqi.net/xmlrpc.php?rsd">
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="http://www.fangdaijisuanqi.net/wlwmanifest.xml">
    <link rel="alternate" type="application/rss+xml" title="RSS" href="http://www.fangdaijisuanqi.net/rss.php">
    <script src="https://cdn.bootcss.com/jquery/3.3.1/jquery.min.js"></script>
    <script src="load/houseloan_calculator.js"></script>
    <link rel="stylesheet" href="load/common.min.css">
    <link rel="stylesheet" href="load/houseloan.min.css">
</head>
<body>
<div class="container">
    <div class="calculator">
        <div view="calc_input" style="display:block;">
            <div class="ui-bar" skin="title">
                ...
                <a href="javascript:;" onclick="history.go(-1)" style="text-align:left;display: inline-block;width: 60px;padding-top: 12px;height: 32px;position: absolute;left: 15px;top:0">
                    <img src="img/ic_back.png" height="17" width="9" style="display: inline-block;"/>
                </a>
            </div>
            <nav class="switch-tabs big-switch-tabs">
                <ul>
                    <li id="business_calc" class="tab normal-tab">
                        <a href="javascript:void(0)">商业贷款计算器</a>
                    </li>
                    <li id="PAF_calc" class="tab normal-tab">
                        <a href="javascript:void(0)">公积金贷款计算器</a>
                    </li>
                    <li id="mix_calc" class="tab select-tab">
                        <a href="javascript:void(0)">组合贷款计算器</a>
                    </li>
                </ul>
            </nav>
        ...
        <div class="calc-result hide" view="calc_result">
            <header class="ui-bar" skin="title">
                ...
                <div class="left">
                    <a id="back_to_calc_input" class="ui-btn" skin="mini back" wrap="t5" style="padding-left: 0;margin-top: 7px;">
                        <img src="img/ic_back.png" height="17" width="9" style="padding-top: 2px;"/></a>
                </div>
            </header>
